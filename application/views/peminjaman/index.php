<div class="panel panel-primary">
    <div class="panel-heading">Panel Peminjaman</div>
    	<div class="panel-body">
    		...
    		<a href="<?php echo site_url()?>peminjaman/create" class="btn btn-primary">Tambah</a>
    			
    		</div>
			<div class="table-responsive">
    		<table class="table table-bordered table-hover" id="tbl_peminjaman">
    			<thead>
    				<tr>
                        <th>No</th>
    					<th>No Faktur</th>
    			...
    			<tbody>
    				...
    				<tr>
    					...
    					<td class="tbl_center">
    						<a href="<?php echo site_url()?>peminjaman/update?id=<?php echo $value->id ?>" class="btn btn-primary  btn-xs"><i class="glyphicon glyphicon-pencil"></i> edit</a>
...
<script type="text/javascript">
	$(document).on('click','#tambah_post',function(){
		...
		$.ajax({ 
		    type: 'GET', 
		    url: "<?php echo base_url().'peminjaman/get'?>", 
